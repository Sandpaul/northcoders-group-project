...
@pytest.mark.it(
    "should retrieve data from a file in the ingestion bucket and return it as a dictionary"
)  # noqa
def test_reads_data_from_file_in_s3(s3, bucket, example_data):
    """should successfully read data from a file in an s3 bucket and return it as a dictionary"""  # noqa
